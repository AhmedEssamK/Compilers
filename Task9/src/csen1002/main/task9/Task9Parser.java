...
public class Task9Parser extends Parser {
	...
	public final FContext f() throws RecognitionException {
		...
		try {
			...
			((FContext)_localctx).m =  ((FContext)_localctx).t.m; ((FContext)_localctx).check =  ((FContext)_localctx).d.check * ((FContext)_localctx).t.check;
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final TContext t(int r,int l) throws RecognitionException {
		...
		try {
			...
			case T__0:
				...
				((TContext)_localctx).m =  ((TContext)_localctx).n.m; ((TContext)_localctx).check =  ((TContext)_localctx).n.check; 
				}
				break;
			case EOF:
	...
	public final NContext n(int r,int c,int l) throws RecognitionException {
		...
		try {
			...
			((NContext)_localctx).t = t(_localctx.r+1,_localctx.l);
			                                                ...
			                                                ((NContext)_localctx).check =  ((NContext)_localctx).d.check * ((NContext)_localctx).t.check;
			                                                ((NContext)_localctx).m =  equals(((NContext)_localctx).d.l, _localctx.l) * ((NContext)_localctx).t.m;
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
